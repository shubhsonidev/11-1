      ...
      .subscribe((res) => {
        if (res.data[0].status === 'success') {
          ...
          if(this.messageConfigService.data[1].emiMessage){
            this.http.get<any>('https://soft7.in/api/send?number=91' + data.number +'&type=text&message=सम्मानीय+' + data.name+',%0A%0Aआपकी+किश्त+('+amount+'/-)+%0A'+ result +'+को+जमा+कर+ली+गई+है|%0Aधन्यवाद%0A%0ACard+Number-'+code+'%0A%0Aहरिदर्शन+ज्वेलर्स%0Aबीना&instance_id=65785DBA24637&access_token=6578021f0b174').subscribe((res) => {})
          }
        }
